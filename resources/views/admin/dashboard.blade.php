    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <div class="text-muted">Blogs, services, and contact messages overview</div>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.blog-posts.create') }}" class="btn btn-primary">New Blog Post</a>
                        <a href="{{ route('admin.services.create') }}" class="btn btn-soft-primary">New Service</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card card-animate">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <div class="text-muted text-uppercase">Blog Posts</div>
                                <div class="fs-22 fw-semibold">{{ $blogPostsTotal }}</div>
                                <div class="text-muted">Published: {{ $blogPostsPublished }}</div>
                            </div>
                            <div class="avatar-sm">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('admin.blog-posts.index') }}" class="text-decoration-underline text-muted">Manage blog posts</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card card-animate">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <div class="text-muted text-uppercase">Services</div>
                                <div class="fs-22 fw-semibold">{{ $servicesTotal }}</div>
                                <div class="text-muted">Active: {{ $servicesActive }}</div>
                            </div>
                            <div class="avatar-sm">
                                <span class="avatar-title bg-success-subtle rounded fs-3">
                                    <i class="las la-cubes text-success"></i>
                                </span>
                            </div>
                        </div>
                        <div class="mt-3">
                            <a href="{{ route('admin.services.index') }}" class="text-decoration-underline text-muted">Manage services</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-12">
                <div class="card card-animate">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <div class="text-muted text-uppercase">Contact Messages</div>
                                <div class="fs-22 fw-semibold">{{ $contactTotal }}</div>
                                <div class="text-muted">Unread: {{ $contactUnread }}</div>
                            </div>
                            <div class="avatar-sm">
                                <span class="avatar-title bg-warning-subtle rounded fs-3">
                                    <i class="las la-envelope text-warning"></i>
                                </span>
                            </div>
                        </div>
                        <div class="mt-3">
                            <a href="{{ route('admin.contact-messages.index') }}" class="text-decoration-underline text-muted">View inbox</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Activity (Last 14 days)</h4>
                    </div>
                    <div class="card-body">
                        <div id="activity_chart" class="apex-charts" data-colors='["--vz-primary", "--vz-success", "--vz-warning"]'></div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Blog Engagement</h4>
                    </div>
                    <div class="card-body">
                        <div id="engagement_chart" class="apex-charts" data-colors='["--vz-info", "--vz-danger", "--vz-primary", "--vz-success"]'></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Blog Views (Last 14 days)</h4>
                    </div>
                    <div class="card-body">
                        <div id="blog_views_chart" class="apex-charts" data-colors='["--vz-info"]'></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                (function () {
                    function getChartColorsArray(chartId) {
                        ...
                        return colors.map(function (value) {
                            ...
                            var css = getComputedStyle(document.documentElement).getPropertyValue(clean);
                            return css || clean;
                        });
                    }

                    var categories = @json($categories['labels'] ?? []);
                    var activity = @json($activity ?? []);
                    var viewsByDay = @json($viewsByDay ?? []);
                    var engagement = @json($engagement ?? []);

                    var activityColors = getChartColorsArray('activity_chart');
                    if (activityColors) {
                        new ApexCharts(document.querySelector('#activity_chart'), {
                            series: [
                                { name: 'Blog posts', data: activity.blog_posts || [] },
                                { name: 'Services', data: activity.services || [] },
                                { name: 'Contact messages', data: activity.contact_messages || [] },
                            ],
                    ...
                    var engagementColors = getChartColorsArray('engagement_chart');
                    if (engagementColors) {
                        new ApexCharts(document.querySelector('#engagement_chart'), {
                            series: [engagement.views || 0, engagement.likes || 0, engagement.shares || 0, engagement.comments || 0],
                    ...
                    var blogViewsColors = getChartColorsArray('blog_views_chart');
                    if (blogViewsColors) {
                        new ApexCharts(document.querySelector('#blog_views_chart'), {
                            series: [{ name: 'Views', data: viewsByDay || [] }],
                            chart: { type: 'bar', height: 300, toolbar: { show: false } },
                            plotOptions: { bar: { columnWidth: '45%' } },
                            xaxis: { categories: categories },
                            colors: blogViewsColors,
                        }).render();
                    }
                })();
            </script>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                <img src='{{asset("assets/admin/images/products/img-1.png")}}' alt="" class="img-fluid d-block" />
                                                            </div>
                                                            <div>
                                                                <h5 class="fs-14 my-1"><a href="{{ route('dashboard') }}" class="text-reset">Branded
                                                                        T-Shirts</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                <img src='{{asset("assets/admin/images/products/img-2.png")}}' alt="" class="img-fluid d-block" />
                                                            </div>
                                                            <div>
                                                                <h5 class="fs-14 my-1"><a href="{{ route('dashboard') }}" class="text-reset">Bentwood
                                                                        Chair</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                <img src='{{asset("assets/admin/images/products/img-3.png")}}' alt="" class="img-fluid d-block" />
                                                            </div>
                                                            <div>
                                                                <h5 class="fs-14 my-1"><a href="{{ route('dashboard') }}" class="text-reset">Borosil Paper
                                                                        Cup</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                <img src='{{asset("assets/admin/images/products/img-4.png")}}' alt="" class="img-fluid d-block" />
                                                            </div>
                                                            <div>
                                                                <h5 class="fs-14 my-1"><a href="{{ route('dashboard') }}" class="text-reset">One Seater
                                                                        Sofa</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm bg-light rounded p-1 me-2">
                                                                <img src='{{asset("assets/admin/images/products/img-5.png")}}' alt="" class="img-fluid d-block" />
                                                            </div>
                                                            <div>
                                                                <h5 class="fs-14 my-1"><a href="{{ route('dashboard') }}" class="text-reset">Stillbird
                                                                        Helmet</a></h5>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src='{{asset("assets/admin/images/companies/img-1.png")}}' alt="" class="avatar-sm p-2" />
                                                            </div>
                                                            <div>
                                                                <h5 class="fs-14 my-1 fw-medium"><a href="{{ route('dashboard') }}" class="text-reset">iTest Factory</a>
                                                                </h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src='{{asset("assets/admin/images/companies/img-2.png")}}' alt="" class="avatar-sm p-2" />
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-14 my-1 fw-medium"><a href="{{ route('dashboard') }}" class="text-reset">Digitech
                                                                        Galaxy</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src='{{asset("assets/admin/images/companies/img-3.png")}}' alt="" class="avatar-sm p-2" />
                                                            </div>
                                                            <div class="flex-gow-1">
                                                                <h5 class="fs-14 my-1 fw-medium"><a href="{{ route('dashboard') }}" class="text-reset">Nesta
                                                                        Technologies</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src='{{asset("assets/admin/images/companies/img-8.png")}}' alt="" class="avatar-sm p-2" />
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-14 my-1 fw-medium"><a href="{{ route('dashboard') }}" class="text-reset">Zoetic
                                                                        Fashion</a></h5>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src='{{asset("assets/admin/images/companies/img-5.png")}}' alt="" class="avatar-sm p-2" />
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-14 my-1 fw-medium"><a href="{{ route('dashboard') }}" class="text-reset">Meta4Systems</a>
                                                                </h5>
                                    ...
                                    <div class="table-responsive table-card">
                                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="{{ route('dashboard') }}" class="fw-medium link-primary">#VZ2112</a>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="{{ route('dashboard') }}" class="fw-medium link-primary">#VZ2111</a>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src='{{asset("assets/admin/images/users/avatar-2.jpg")}}' alt="" class="avatar-xs rounded-circle" />
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="{{ route('dashboard') }}" class="fw-medium link-primary">#VZ2109</a>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src='{{asset("assets/admin/images/users/avatar-3.jpg")}}' alt="" class="avatar-xs rounded-circle" />
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="{{ route('dashboard') }}" class="fw-medium link-primary">#VZ2108</a>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src='{{asset("assets/admin/images/users/avatar-4.jpg")}}' alt="" class="avatar-xs rounded-circle" />
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="{{ route('dashboard') }}" class="fw-medium link-primary">#VZ2107</a>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src='{{asset("assets/admin/images/users/avatar-6.jpg")}}' alt="" class="avatar-xs rounded-circle" />
                                                            </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                                <div class="acitivity-timeline acitivity-main">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                                <a href="{{ route('dashboard') }}" class="bg-light rounded p-1">
                                                ...
                                                <a href="{{ route('dashboard') }}" class="bg-light rounded p-1">
                                                    <img src='{{asset("assets/admin/images/products/img-10.png")}}' alt="" class="img-fluid d-block" />
                                                </a>
                                            </div>
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        <div class="flex-shrink-0">
                                            <img src='{{asset("assets/admin/images/users/avatar-2.jpg")}}' alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1 lh-base">Today offers by <a href="{{ route('dashboard') }}" class="link-secondary">Digitech Galaxy</a></h6>
                                    ...
                                    <div class="acitivity-item d-flex">
                                        <div class="flex-shrink-0">
                                            <img src='{{asset("assets/admin/images/users/avatar-3.jpg")}}' alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 avatar-sm">
                                                            <div class="avatar-title bg-light rounded">
                                                                <img src='{{asset("assets/admin/images/companies/img-1.png")}}' alt="" height="30">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src='{{asset("assets/admin/images/users/avatar-3.jpg")}}' alt="" class="avatar-sm rounded">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <div>
                                                                <p class="text-muted mb-1 fst-italic text-truncate-two-lines">
                                            ...
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 avatar-sm">
                                                            <div class="avatar-title bg-light rounded">
                                                                <img src='{{asset("assets/admin/images/companies/img-8.png")}}' alt="" height="30">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src='{{asset("assets/admin/images/users/avatar-2.jpg")}}' alt="" class="avatar-sm rounded">
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                                            <div>
                                                                <p class="text-muted mb-1 fst-italic text-truncate-two-lines">
